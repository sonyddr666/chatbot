...
BUILTIN_PROVIDERS = {
    ...
    "codex-chatgpt": {
        ...
        "enabled": True,
        "models": [
            {"id": "gpt-5.5",             "name": "GPT-5.5 (Codex)",              "context_length": 128000, "enabled": True},
            {"id": "gpt-5.4",             "name": "GPT-5.4 (Codex)",              "context_length": 1050000, "enabled": True},
            {"id": "gpt-5.4-mini",        "name": "GPT-5.4 Mini (Codex)",         "context_length": 1050000, "enabled": False},
            {"id": "gpt-5.3-codex-spark", "name": "GPT-5.3 Codex Spark (Codex)",  "context_length": 400000, "enabled": False},
        ],
    },
}
